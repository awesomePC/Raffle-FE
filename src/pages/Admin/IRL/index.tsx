...
import { Connection, Keypair, Commitment, ConnectionConfig, clusterApiUrl } from "@solana/web3.js";
...
const IRLCreate = () => {
  ...
  const fileTypes = ["JPG", "PNG", "GIF", "SVG", "MP4", "WEBM", "MP3", "WAV", "OGG", "GLB", "GLTF", "AVIF", "WEBP"];
    ...
    <div className="relative">
      ...
      <div className="max-w-[810px] m-auto pt-20 pb-16 px-4 md:px-0">
                ...
                {!file ? (
                  <>
                    ...
                    <p className="dark:text-jacarta-300 mx-auto max-w-xs text-xs">
                      JPG, PNG, GIF,AVIF, WEBP, SVG, MP4, WEBM, MP3, WAV, OGG, GLB, GLTF. Max size: 100 MB
                    </p>
                  </>
                ) : (
        ...
        <div
          ...
          className="cursor-pointer bg-btngrad text-white rounded-full flex items-center py-3 px-5 max-w-fit mx-[auto] my-0 mt-[-27px] "
        >
          MINT
        </div>
        <ToastContainer />

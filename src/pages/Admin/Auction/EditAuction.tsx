...
const EditAuction = () => {
  ...
  const handleAuctionSubmit = async () => {
    try {
      ...
      payload.append("start_date", Math.floor(auctionValue.start_date?.getTime() / 1000).toString());
      payload.append("end_date", (Math.floor(auctionValue.end_date?.getTime()) / 1000).toString());
          ...
          <div className="mt-6 md:px-8 px-4 pt-8 pb-14 bg-blackbg rounded-[0.7rem]">
            <div className="md:flex block justify-between items-start">
              ...
              <div className="basis-[48%]">
                ...
                <div className="mb-5">
                  <label className="text-white text-lg inline-block mb-1" htmlFor="ticketdate">
                    End Date
                  </label>
                  <div className="relative border border-[#ffffff99]  rounded-full overflow-hidden">
                    <input
                ...
                <div className="mb-5">
                  <label className="text-white text-lg inline-block mb-1" htmlFor="bidprice">
                    Min. Bid Amount
                  </label>
                  <div className="relative border border-[#ffffff99]  rounded-full overflow-hidden">
                    <input
                ...
                <div className="mb-5">
                  <label className="text-white text-lg inline-block mb-1" htmlFor="bidIncrement">
                    Min. Bid Increment
                  </label>
                  <div className="relative border border-[#ffffff99]  rounded-full overflow-hidden">
                    <input

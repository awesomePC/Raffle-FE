...
const EditRaffle = () => {
  ...
  const handleRaffleUpdateBtn = async () => {
    try {
      ...
      const updateRaffleRes = await editForRaffle(anchorWallet, raffleValue);
      if (updateRaffleRes) {
          ...
          <div className="mt-6 md:px-8 px-4 pt-8 pb-14 bg-blackbg rounded-[0.7rem]">
            <div className="md:flex block justify-between items-start">
              ...
              <div className="basis-[48%]">
                ...
                {/* <div className="mb-5">
                  <label className="text-white text-lg inline-block mb-1" htmlFor="minNftCount">
                    Min NFT Count
                  </label>
                  <div className="relative border border-[#ffffff99]  rounded-full overflow-hidden">
                    <input
                ...
                <div className="mb-5">
                  <label className="text-white text-lg inline-block mb-1" htmlFor="description">
                    Description
                  </label>
          ...
          <div className="flex justify-center gap-[16px] ">
            <div className="flex justify-center -mt-6">
              <p
                ...
                className={` ${
                  updateBtnActive ? `cursor-pointer opacity-100` : `cursor-not-allowed opacity-70`
                }  text-white bg-btngrad rounded-full flex items-center py-3 px-5`}
              >
                Update Raffle
              </p>
            </div>

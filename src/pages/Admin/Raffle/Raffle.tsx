...
const AdminRaffle = () => {
  ...
  const getData = async () => {
    try {
      ...
      const pastData = final_raffle_All.filter((item: any) => item.end_date < Date.now() / 1000);
                              ...
                              <div className="my-2">
                                ...
                                <div className="relative border border-pink rounded-full overflow-hidden">
                                  <input
                                    ...
                                    onChange={(e) =>
                                      setFilterData({ ...filterData, endDate: new Date(e.target.value) })
                                    }
                                  />
                                </div>
                              </div>
                        ...
                        <div className="basis-[77%]">
                          ...
                          <div className="flex gap-[1rem] flex-wrap">
                            {isFilterByItem.length > 0 ? (
                              isFilterByItem.map((item: any, id: any) => <FilterRaffles item={item} />)
                            ) : (
              ...
              <>
                ...
                <div className="flex gap-[1rem] flex-wrap pb-12 md:max-w-[768px] lg:max-w-[100%] sm:max-w-[100%] md:m-auto">
                  {isLoading ? (
                    ...
                    featuredData.map((item: any, id: any) => <RaffleItem item={item} />)
                  ) : (
                    <div className="text-white">There is no Raffle Data</div>
                  )}
                </div>
              ...
              <>
                ...
                <div className="flex gap-[1rem] flex-wrap pb-12 md:max-w-[768px] lg:max-w-[100%] sm:max-w-[100%] md:m-auto">
                  {isLoading ? (
                    ...
                    raffleData.map((item: any, id: any) => <RaffleItem item={item} />)
                  ) : (
                    <div className="text-white">There is no Raffle Data</div>
                  )}
                </div>
              ...
              <>
                ...
                <div className="flex gap-[1rem] flex-wrap pb-12 md:max-w-[768px] lg:max-w-[100%] sm:max-w-[100%] md:m-auto">
                  {isLoading ? (
                    ...
                    pastData.map((item: any, id: any) => <RaffleItem item={item} />)
                  ) : (
                    <div className="text-white">There is no Raffle Data</div>
                  )}
                </div>

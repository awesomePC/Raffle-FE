...
const CreateRaffle = () => {
  ...
  const handleRuffleSubmit = async () => {
    try {
      ...
      payload.append('tokenAddress', raffleValue.tokenAddress);
      payload.append("price", raffleValue.price);
      payload.append("start_date", Math.floor(raffleValue.start_date?.getTime() / 1000).toString());
      payload.append("end_date", Math.floor(raffleValue.end_date?.getTime() / 1000).toString());
    ...
    <div>
      ...
      <div className="bg-black">
        ...
        <div className="max-w-[768px] m-auto pt-20 pb-16 px-4 md:px-0">
          ...
          <div className="mt-6 md:px-8 px-4 pt-8 pb-14 bg-blackbg rounded-[0.7rem]">
            <div className="md:flex block justify-between items-start">
              <label
                htmlFor="profilePic"
                className="border md:mb-0 mb-4 min-h-[295px] basis-[46%] flex items-center justify-center flex-col p-8 border-[#ffffff99] rounded-[0.7rem] cursor-pointer"
              ...
              <div className="mb-5">
                  <label className="text-white text-lg inline-block mb-1" htmlFor="tokenaddress">
                    Token Address
                  </label>
                  <div className="relative border border-[#ffffff99] rounded-full overflow-hidden">
                    <input
                      ...
                      id="tokenaddress"
                      name="tokenaddress"
                      placeholder="55u5jMiJtwsvyo834R2mmcrxMGu7x2KvbrguJNbHFnEJ"
                      value={raffleValue.tokenAddress}
                      onChange={(e) => {
                        setRaffleValue({
                          ...raffleValue,
                      ...
                      className="bg-transparent w-full text-[#fff] placeholder:text-[#606060] p-3 outline-none"
                    />
                  </div>
                </div>
                <div className="mb-5">
                  <label className="text-white text-lg inline-block mb-1" htmlFor="ticketprice">
                    Ticket Price
                  </label>
                  <div className="relative border border-[#ffffff99] rounded-full overflow-hidden">
                    <input
                ...
                <div className="mb-5">
                  <label className="text-white text-lg inline-block mb-1" htmlFor="startdate">
                    Start Date
                  </label>
                  <div className="relative border border-[#ffffff99] rounded-full overflow-hidden">
                    <input
                ...
                <div className="mb-5">
                  <label className="text-white text-lg inline-block mb-1" htmlFor="enddate">
                    End Date
                  </label>
                  <div className="relative border border-[#ffffff99] rounded-full overflow-hidden">
                    <input
                ...
                <div className="mb-5">
                  <label className="text-white text-lg inline-block mb-1" htmlFor="ticketsupply">
                    Total Ticket Supply
                  </label>
                  <div className="relative border border-[#ffffff99] rounded-full overflow-hidden">
                    <input
                ...
                {/* <div className="mb-5">
                  <label className="text-white text-lg inline-block mb-1" htmlFor="nftcount">
                    Min. NFT Count
                  </label>
                  <div className="relative border border-[#ffffff99] rounded-full overflow-hidden">
                    <input
                ...
                <div className="mb-5">
                  <label className="text-white text-lg inline-block mb-1" htmlFor="twitterlink">
                    Twitter Link
                  </label>
                  <div className="relative border border-[#ffffff99] rounded-full overflow-hidden">
                    <input
                ...
                <div className="mb-5">
                  <label className="text-white text-lg inline-block mb-1" htmlFor="discordlink">
                    Discord Link
                  </label>
                  <div className="relative border border-[#ffffff99] rounded-full overflow-hidden">
                    <input
                ...
                <div className="mb-5">
                  <label className="text-white text-lg inline-block mb-1" htmlFor="Terms & Conditions">
                    Terms & Conditions
                  </label>
                  <div className="relative  overflow-hidden">
                    <textarea
                      ...
                      className="bg-transparent border border-[#ffffff99] rounded-xl w-full text-[#ffffff] placeholder:text-[#606060] p-3 outline-none resize-none h-full"
                    />
                  </div>
                </div>
                <div></div>
          ...
          <div className="flex justify-center -mt-6">
            <p
              ...
              className="cursor-pointer text-white bg-btngrad rounded-full flex items-center py-3 px-5"
            >
              Create Raffle
            </p>
          </div>
